 ...
 // Tracks the current sort state
  ...
  return (
    <div className="relative">
      <div className="flex w-screen py-1 bg-white">
      ...
      <div
        ref={div1Ref}
        className={`fixed bg-white bottom-0 left-1/2 transform -translate-x-1/2 w-full  bg-primary text-primary-foreground p-2 rounded-t-xl transition-transform duration-300 ease-in-out z-30 ${
        ...
        <div className="max-h-[70vh] overflow-y-auto">
          <div className="flex flex-col justify-start items-start">
            ...
            <div className="w-full border-t rounded-t-xl">
              <button
                onClick={closeDiv}
                className="bg-pink-500 text-white rounded-xl p-2 w-full btn-small"
              >
                Done
              </button>
            </div>
